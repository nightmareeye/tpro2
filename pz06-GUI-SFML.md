## Практическое занятие №6. Разработка графических приложений
...
После установки библиотеки открываем Clion и создаём проект С++ с названием "SfmlApp". Далее необходимо внести изменения в файл CmakeList.txt.
```
...
3. При вводе пользователем слова "window" открывыть новое окно, название которого должно совпадать с вашим username. В момент появления нового окна события главного окна не должны быть доступными(смотрите указания ниже). На скриншоте продемонстрировать 2 созданных окна, дочернее окно должно иметь название: username-текущая дата
